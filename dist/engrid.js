 ...
 *
 *  Date: Tuesday, May 30, 2023 @ 17:14:33 ET
 *  By: fernando
...
class DonationLightboxForm {
  constructor(DonationAmount, DonationFrequency) {
    ...
    if (pageJson.pageNumber === pageJson.pageCount) {
      ...
      document.querySelector("body").dataset.thankYou = "true"; // Try to get the first name
  ...
  validateForm() {
    ...
    const amount = this.checkNested(window.EngagingNetworks, "require", "_defined", "enjs", "getDonationTotal") ? window.EngagingNetworks.require._defined.enjs.getDonationTotal() : 0;
